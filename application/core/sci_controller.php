...
# This SCI controller is the base controller for all Controller in this application 
# Created By : Shahed
...
class SCI_Controller extends CI_Controller {
    ...
    public function load_view($view_name) {
        $this->load->view('admin_lte/header');
        $this->load_head();
        $this->load_left_menu();
        $this->load->view('admin_lte/component/container_start');
        $this->load->view($view_name, $this->val);
        $this->load->view('admin_lte/component/container_end');
        $this->load_footer();
    }
